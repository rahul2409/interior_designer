	...
	<div class="project-section-bg">
		<div class="project-section-img">
			<div class="project-img-text">
				<p class="project-img-text-content"><span class="gold-text">Home</span> / Projects</p>
			</div>
		</div>
	</div>
...
<!----PROJECT DISPLAY MENU ---->
	<div class="project-portfolio">
		<ul class="portfolio-list">
			...
			<li data-filter=".hospital">Hospitals</li>
			<li data-filter=".office">Office</li>
			<li data-filter=".shop">Shop</li>
		</ul>
		<div class="portfolio-grid clearfix">
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/1.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
					<i class="fa fa-heart"> <span>19</span></i>
					</div>
				</div>
			</div>
			<div class="catalog-item pull-left item hospital">
				<a href=""><img src="vendors/images/Projects/hospital/1.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item office">
				<a href=""><img src="vendors/images/Projects/office/1.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/2.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item office">
				<a href=""><img src="vendors/images/Projects/office/2.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item shop">
				<a href=""><img src="vendors/images/Projects/shop/1.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/3.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item hospital">
				<a href=""><img src="vendors/images/Projects/hospital/2.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item office">
				<a href=""><img src="vendors/images/Projects/office/4.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/4.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/5.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item hospital">
				<a href=""><img src="vendors/images/Projects/hospital/3.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item residential">
				<a href=""><img src="vendors/images/Projects/residential/6.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
			...
			<div class="catalog-item pull-left item office">
				<a href=""><img src="vendors/images/Projects/office/3.jpg" alt=""></a>
				<div class="catalog-item-text">
					<h3 class="catalog-item-text-header">Projects</h3>
					<p class="catalog-item-text-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
					<div class="catalog-icon clearfix">
